...
from prompting.active_prompt import get_active_prompt_prediction_single_category
...
def evaluate_active_prompt(data_path: str, api_key: str, output_dir: str = "results/active_prompt", limit: int = None):
    """Evaluate Active Prompting technique on Bloom taxonomy dataset."""
...
if __name__ == "__main__":
    ...
    # Run evaluation
    try:
        print("\nStarting Active Prompting evaluation on Bloom taxonomy dataset...")

...
from prompting.contrastive_cot import get_contrastive_cot_prediction_single_category
...
def evaluate_contrastive_cot(data_path: str, api_key: str, output_dir: str = "results/contrastive_cot", limit: int = None):
    """Evaluate Contrastive CoT prompting technique on Bloom taxonomy dataset."""
    ...
    for seq, (_, row) in enumerate(df.iterrows(), start=1):
        ...
        try:
            ...
            # Get model predictions with Contrastive CoT
    ...
    # Print results
    print_detailed_results(metrics, categories, 'Contrastive CoT')
...
if __name__ == "__main__":
    ...
    # Run evaluation
    try:
        print("\nStarting Contrastive CoT evaluation on Bloom taxonomy dataset...")

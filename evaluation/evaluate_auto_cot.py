...
from prompting.auto_cot import get_auto_cot_prediction_single_category
...
def evaluate_auto_cot(data_path: str, api_key: str, output_dir: str = "results/auto_cot", limit: int = None):
    """Evaluate Auto-CoT prompting technique on Bloom taxonomy dataset."""
    ...
    for seq, (_, row) in enumerate(df.iterrows(), start=1):
        ...
        try:
            ...
            # Get model predictions with Auto-CoT
    ...
    # Print results
    print_detailed_results(metrics, categories, 'Auto-CoT')
...
if __name__ == "__main__":
    ...
    # Run evaluation
    try:
        print("\nStarting Auto-CoT evaluation on Bloom taxonomy dataset...")

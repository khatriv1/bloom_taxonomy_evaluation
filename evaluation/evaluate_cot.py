...
from prompting.cot import get_cot_prediction_single_category
...
def evaluate_cot(data_path: str, api_key: str, output_dir: str = "results/cot", limit: int = None):
    """Evaluate Chain of Thought prompting technique on Bloom taxonomy dataset."""
    ...
    for seq, (_, row) in enumerate(df.iterrows(), start=1):
        ...
        try:
            ...
            # Get model predictions with Chain of Thought
    ...
    # Print results
    print_detailed_results(metrics, categories, 'Chain of Thought')
...
if __name__ == "__main__":
    ...
    # Run evaluation
    try:
        print("\nStarting Chain of Thought evaluation on Bloom taxonomy dataset...")

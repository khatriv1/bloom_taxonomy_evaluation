...
from prompting.few_shot import get_few_shot_prediction_single_category
...
def evaluate_few_shot(data_path: str, api_key: str, output_dir: str = "results/few_shot", limit: int = None):
    """Evaluate Few-shot prompting technique on Bloom taxonomy dataset."""
    ...
    for seq, (_, row) in enumerate(df.iterrows(), start=1):
        ...
        try:
            ...
            # Get model predictions with Few-shot
    ...
    # Print results
    print_detailed_results(metrics, categories, 'Few-shot')
...
if __name__ == "__main__":
    ...
    # Run evaluation
    try:
        print("\nStarting Few-shot evaluation on Bloom taxonomy dataset...")

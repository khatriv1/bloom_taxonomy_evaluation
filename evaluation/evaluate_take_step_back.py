...
from prompting.take_a_step_back import get_take_step_back_prediction_single_category
...
def evaluate_take_step_back(data_path: str, api_key: str, output_dir: str = "results/take_step_back", limit: int = None):
    """Evaluate Take a Step Back prompting technique on Bloom taxonomy dataset."""
...
if __name__ == "__main__":
    ...
    # Run evaluation
    try:
        print("\nStarting Take a Step Back evaluation on Bloom taxonomy dataset...")
